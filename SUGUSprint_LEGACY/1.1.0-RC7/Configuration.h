...
#define CUSTOM_MACHINE_NAME "SugusPrinter :D"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,652}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {300, 300, 2, 5}    // (mm/sec)
